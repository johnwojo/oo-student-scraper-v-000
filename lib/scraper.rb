...
class Scraper
  ...
  def self.scrape_index_page(index_url)
   ...
   def self.scrape_profile_page(profile_url)
    ...
    student = {}
    profile.css(".social-icon-container a").each do |link|  # This line takes each of the links in the social container and calls them a "link."
    ...
    student[:education] = profile.css('.details-container .education-block details-block .description-holder h4').text
    student
  end
end
